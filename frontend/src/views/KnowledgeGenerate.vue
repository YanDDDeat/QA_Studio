    ...
    <el-card class="results-card">
      ...
      <div class="results-body">
        ...
        >
          ...
          <el-table-column label="知识(knowledge)" min-width="180">
            <template #default="{ row }">
              {{ truncateText(row.knowledge) }}
            </template>
          </el-table-column>
          <el-table-column prop="scene" label="场景(scene)" width="120" show-overflow-tooltip />
    ...
    <el-dialog v-model="detailVisible" title="记录详情" width="700px" :append-to-body="true">
      <template v-if="detailRecord">
        <el-descriptions :column="2" border size="small">
          ...
          <el-descriptions-item label="scene">{{ detailRecord.scene || '-' }}</el-descriptions-item>
        </el-descriptions>
        ...
        <div class="detail-text-fields">
          ...
          <div class="text-field-block" v-if="detailRecord.knowledge">
            <div class="field-label">知识 (Knowledge)</div>
            <div class="field-content" v-html="renderKnowledge(detailRecord.knowledge)"></div>
          </div>
        </div>
      </template>
    </el-dialog>
