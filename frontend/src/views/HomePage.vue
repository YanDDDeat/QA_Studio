  ...
  <div class="home-page">
    ...
    <header class="home-nav">
      <div class="nav-inner">
        ...
        <nav class="nav-links">
          <a href="https://github.com/YanDDDeat/QA_Studio" target="_blank" class="nav-link">
    ...
    <section class="hero-section">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          ...
          <a class="btn-secondary" href="https://github.com/YanDDDeat/QA_Studio" target="_blank">
            GitHub →
          </a>
        </div>
      </div>
