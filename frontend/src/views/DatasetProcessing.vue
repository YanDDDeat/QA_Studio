    ...
    <el-card class="section-card">
      ...
      <div class="config-layout">
        ...
        <div class="config-preview">
          <PromptPreview :version="assessDrawerVersion" :content="assessDrawerContent" :time-label="formatTime(assessDrawerCreatedAt)" :content-changed="assessDrawerContentChanged" :next-version="assessNextVersion" :save-loading="assessSaveLoading" stage="dataset_assessment" @update:content="assessDrawerContent = $event" @save="assessSaveAsNewVersion" />
        </div>
      </div>
