...
CREATE TABLE IF NOT EXISTS `datasets` (
    ...
    `current_stage` ENUM('question_generate','knowledge_generate','question_validate','answer_generate','answer_validate','data_evaluate') DEFAULT 'question_generate',
    `created_at`    DATETIME     DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `files` (
    ...
    `source_stage`  ENUM('question_generate','knowledge_generate','question_validate','answer_generate','answer_validate','data_evaluate') DEFAULT NULL COMMENT '来源阶段(校验失败文件标记)',
...
CREATE TABLE IF NOT EXISTS `prompts` (
    `id`         INT          NOT NULL AUTO_INCREMENT,
    `user_id`    INT          NOT NULL,
    `stage`      ENUM('question_generate','knowledge_generate','question_validate','answer_generate','answer_validate','data_evaluate') NOT NULL,
